...
console.log(
  'Write JSON to file: pnpm run benchmark:contract -- --out tmp/contract-benchmark.json',
)
console.log(
  'Write Markdown to file: pnpm run benchmark:contract -- --markdown --out tmp/contract-benchmark.md',
)
console.log('')
console.log(
  'Next step: implement repeatable measurement harness and output JSON/Markdown summaries.',
)
