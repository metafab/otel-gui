...
// a separate connection per view (traces / logs / metrics / service map). That
// kept 4–5 of the browser's ~6-connection-per-origin budget permanently
// occupied and starved regular fetches + navigation. Here, every store/view
// registers its listeners on a single connection via onSSE().
//
